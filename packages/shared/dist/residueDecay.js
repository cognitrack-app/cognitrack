...
exports.decayResidue = decayResidue;
 ...
 */
function decayResidue(residue, deltaMs) {
    if (deltaMs <= 0)
        return residue;
    return residue * Math.exp(-deltaMs / constants_1.TAU_MS);
}
/**
 ...
 */
function applySwitch(currentResidue, timeSinceLastSwitchMs, switchCost) {
